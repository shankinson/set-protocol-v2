...
library AaveV3 {
    ...
    /**
     * Get supply calldata from SetToken
     *
     ...
     * @param _useAsCollateral      true` if the user wants to use the supply as collateral, `false` otherwise
     *
     * @return address              Target contract address
     * @return uint256              Call value
